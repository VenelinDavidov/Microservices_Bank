...
public class CustomerServiceImpl implements ICustomerService {
    ...
    public CustomerDetailsDto fetchCustomerDetails(String mobileNumber) {
        ...
        ResponseEntity <LoansRequest> loansDtoResponseEntity = loansFeignClient.fetchLoanDetails (mobileNumber); // calling feign loan service
        customerDetailsDto.setLoansDto (loansDtoResponseEntity.getBody ());

        ResponseEntity <CardsDto> cardsDtoResponseEntity = cardsFeignClient.fetchCardDetails (mobileNumber); // calling feign cards service
